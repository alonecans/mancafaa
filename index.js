...
─────────────────────`
	...
	fakeimagecuy = fs.readFileSync('me.jpg')
   	const mek2 =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 999, status: 500, thumbnail: fakeimagecuy, surface: 500, message: fakereply, orderTitle: fakereply1, sellerJid: '0@s.whatsapp.net'} } }              	 	         
      ...
      client.sendMessage(from, d, sticker, {quoted: {key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage":{"product":{"productImage":{"mimetype":"image/jpeg","height":736,"width":736,"jpegThumbnail":fs.readFileSync(`./me.jpg`)},"productId":"3937202479680283","title":"Wkwkwk","currencyCode":"IDR","priceAmount1000":"999999999000","productImageCount":1},"businessOwnerJid":"0@s.whatsapp.net"}}}})
			...
			switch(command) {
                ...
                if (isBadWord) return reply('*Fitur BadWord sudah aktif sebelum nya*')
                 	   ...
                 	   client.sendMessage(from, 'Sukses menyalakan antibadword',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
                  	   reply(`Fitur Badword Enable!`)
              	  } else if (args[0] === '0') {
                  	  badword.splice(from, 1)
                 	   fs.writeFileSync('./database/kelompok/badword.json', JSON.stringify(badword))
                 	    reply(`Fitur Badword Disable`)
                 	    client.sendMessage(from, 'Sukses Mematikan antibadword',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
             	   } else {
                 	   reply(ind.satukos())
                	}
                    break
...
client.sendMessage(from, 'Sukses Gabung Ke Grup!',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
}, 20000) // 1000 = 1s,
setTimeout( () => {
reply('Oke Desu~')
}, 0) // 1000 = 1s,
		...
		case 'tebakgokil':
                if (!isRegistered) return reply(ind.noregis())
	         	if (!isGroup) return reply(ind.groupo())
					...
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.answer, text, {quoted: mek2}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
...
*➸ Info :* ${anu.result.information}`
					setTimeout( () => {
					client.sendMessage(from, jawab, text, {quoted: mek2}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
		...
		if (!isGroup) return reply(ind.groupo())
					...
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.lambang, text, {quoted: mek2}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					client.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
					...
					setTimeout( () => {
					client.sendMessage(from, kimia, text, {quoted: mek2}) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender) 
					break 
		case 'tebaklirik':
		...
		if (!isGroup) return reply(ind.groupo())
					...
					setTimeout( () => {
					client.sendMessage(from, lirik, text, {quoted: mek2 }) // ur cods
					}, 0) // 1000 = 1s,
					await limitAdd(sender) 
					break 
		/*case 'colong':
...
var req = args.join(' ')            
		...
		case 'setppca':
				...
				client.sendMessage(from, `\`\`\`Sukses Mengganti\`\`\``, MessageType.text, { quoted: mek2 })
				break
		case 'togif':
                                        ...
                                        client.sendMessage(from, buff, video, { mimetype: Mimetype.gif, caption: 'Oke...', quoted: mek2})
                                }
                                await limitAdd(sender)
                                break
		case 'getpic':
		...
		case 'tagimg':
                    ...
                    if ((isMedia && !mek.message.videoMessage || isQuotedSticker) && args.length == 0) {
                        ...
                        ini_buffer = fs.readFileSync(filePath)
                        client.sendMessage(from, ini_buffer, sticker, options, {quoted: mek2})
                        fs.unlinkSync(filePath)
                    } else {
                        reply(`Tag sticker yang sudah dikirim`)
                    }
...
pp_nuy = await getBuffer(pp_user)
                    ...
                    client.sendMessage(from, pp_nuy, image, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: ini_txt })
                    break
		    case 'jawakelatin': 
				if (!isRegistered) return reply(ind.noregis())
...
`
            reply(brow)
	            break
				case 'shutdown':
                client.sendMessage(from, `Oke Desu~`, text, {quoted : mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
                await sleep(5000)
...
_> ${get_result.hasil}_`
                    client.sendMessage(from, bre, text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
                    break
				case 'nightcore':
	                 if (!isQuotedAudio) return reply('Reply audio nya om')
					encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
			...
			case 'slow':
              ...
              case 'tupai':
				...
				case 'addbadword': 
                    if (!isOwner) return reply(ind.ownerb())
                    if (!isGroupAdmins) return reply(ind.admin())
                    if (args.length < 1) return reply( `Kirim perintah ${prefix}addbadword [kata kasar]. contoh ${prefix}addbadword anjim`)
				...
				if (argz.length === 1) return client.sendMessage(from, `Penggunaan fitur antidelete :\n\n*${prefix}antidelete [aktif/mati]* (Untuk grup)\n*${prefix}antidelete [ctaktif/ctmati]* (untuk semua kontak)\n*${prefix}antidelete banct 62838xxxxxxx* (banlist kontak)`, MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
				if (argz[1] == 'aktif') {
					if (isGroup) {
					...
					if (argz.length === 2 || argz[2].startsWith('0')) return client.sendMessage(from, `Masukan nomer diawali dengan 62! contoh 62838156xxxxx`,MessageType.text, {quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
	...
	break
		...
		case 'transfer':
				...
				client.sendMessage(from, 'Kalo Owner Asli #bc\n Kalo Wakil Owner #bcc\nTambahin Huruf 1 Lagi, Di Semua Fitur Owner',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break
                case 'unadmin':
				if (!isOwner) return reply(ind.ownerb())
				adm = body.slice(9)
				admin.push(`${adm}@s.whatsapp.net`)
				fs.writeFileSync('./database/pengguna/admin.json', JSON.stringify(admin))
				client.sendMessage(from, `Berhasil Mencopot Admin Bot wa.me/${adm}`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
				break
                case 'wakillist':
				client.updatePresence(from, Presence.composing) 
                 if (!isRegistered) return reply( ind.noregis())    
				...
				client.sendMessage(from, `Berhasil menambahkan premium wa.me/${premm}`, text, {quoted: mek2})
				break
		case 'unpremium':
				if (!isOwner) return reply(ind.ownerb())
				premm = body.slice(11)
				...
				fs.writeFileSync('./database/pengguna/premium.json', JSON.stringify(prem))
				client.sendMessage(from, `Nomor sudah berakhir menjadi premium wa.me/${premm}`, text, {quoted: mek2})
				break
                case 'premiumlist':
				client.updatePresence(from, Presence.composing) 
...
─────────────────────`
		...
		case 'setppbot':
				    ...
				    client.sendMessage(from, 'Makasih Profile Barunya🤗',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break 
		/*case 'setppbott':
				if (!isAdmin) return reply('*Only Admin bot*')
					client.updatePresence(from, Presence.composing) 
       ...
       if (!isRegistered) return reply(ind.noregis())
		...
		case 'infofilm': 
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, buffer7, image, {quoted: mek2, caption: capt})
					await limitAdd(sender)
					break
		case 'infofilm2': 
                 if (!isRegistered) return reply( ind.noregis())
		...
		case 'heroml':
				...
				client.sendMessage(from, buffer7, image, {quoted: mek2, caption: teks})
				await limitAdd(sender)
				break
				case 'igvideo': 
                 if (!isRegistered) return reply( ind.noregis())
				...
				if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return reply(mess.error.lv)
				 ...
				 case 'ccgenerator': 
				   ...
				   client.sendMessage(from, teks, text, {quoted: mek2})
				   await limitAdd(sender)
				   break
				 case 'ceritahorror': 
					if (!isRegistered) return reply( ind.noregis())
...
pp_nuy = await getBuffer(pp_user)
               ...
               case 'slist':
				...
				if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, teks.trim(), extendedText, {quoted: mek2, contextInfo: { "mentionedJid": setiker}})
					break
              case 'gs':
				case 'gets':
				if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, result, sticker, {quoted: mek2})
					break
              case 'addvn':
				if (!isRegistered) return reply( ind.noregis())
               ...
               case 'vnlist':
				...
				if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, teks.trim(), extendedText, { quoted: mek2, contextInfo: { "mentionedJid": audionye } })
					break
             case 'getvn':
             case 'gvn':
             if (!isRegistered) return reply( ind.noregis())
            ...
            case 'imglist':
				...
				if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, teks.trim(), extendedText, { quoted: mek2, contextInfo: { "mentionedJid": imagenye } })
					break
            case 'gimg':
            case 'getimg':
            if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, buffer, image, { quoted: mek2, caption: `Result From Database : ${namastc}.jpeg` })
					break
            case 'addvid':
				if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, `Sukses Menambahkan Video\nCek dengan cara ${prefix}vidlist`,MessageType.text, { quoted: mek2 })
					break
             case 'vidlist':
				case 'listvid':
				if (!isRegistered) return reply( ind.noregis())
					...
					client.sendMessage(from, teks.trim(), extendedText, { quoted: mek2, contextInfo: { "mentionedJid": videonye } })
					break
             case 'getvid':
             case 'gvid':
                    if (!isRegistered) return reply( ind.noregis())
				...
				if (args.length < 1) return client.sendMessage(from, 'Diperlukan kode bahasa kak!!', text, {quoted: mek})
					...
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							...
							buffer = fs.readFileSync(rano)
							if (err) return reply(ind.stikga())
							client.sendMessage(from, buffer, audio, {quoted: mek2, ptt:true, duration:999999999999})
							fs.unlinkSync(rano)
						})
					})
					await limitAdd(sender)
        ...
        case 'setfx':
					...
					if (!isOwner) return reply(ind.ownerb())
					fxsx = args[0]
					client.sendMessage(from, `*HiasanFxSx berhasil di ubah menjadi* : ${fxsx}`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break 
		case 'setfakereply':
					if (args.length < 1) return
					if (!isOwner) return reply(ind.ownerb())
					fakereply = args[0]
					client.sendMessage(from, `*Fakereply berhasil di ubah menjadi* : ${fakereply}`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break
		case 'setfakereply1':
					if (args.length < 1) return
					if (!isOwner) return reply(ind.ownerb())
					fakereply1 = args[0]
					client.sendMessage(from, `*Fakereply berhasil di ubah menjadi* : ${fakereply1}`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					break
		case 'setlimit':
		case 'addlimit':
					if (args.length < 1) return
		...
		case 'tiktokstalk':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				try {
						if (args.length < 1) return client.sendMessage(from, '*Username mana kak?', text, {quoted: mek2})
		...
		case 'tagall2':
					...
					mentions(`┌───「MANCA TAG」───`+ teks +'└───「 *_FxSx_* 」────', members_id, true)
					break
		case 'clearall':
					if (!isOwner) return reply(ind.ownerb())
		...
		case 'outcaa':
                      ...
                      setTimeout( () => {
                      client.updatePresence(from, Presence.composing) 
                      client.sendMessage(from, 'Oke Wakil Owner 🤗',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
                      }, 0)
                      break			
		case 'bc': 
					if (!isOwner) return reply(ind.ownerb()) 
		...
		case 'bcc': 
				if (!isAdmin) return reply('*Only Admin bot*')
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BC BY WAKIL OWNER 」*\n\n${body.slice(4)}`)
						}
						reply('*Suksess broadcast* ')
					}
					break
      ...
      case 'upswimg':
		...
		case 'simih':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, 'Sukses mengaktifkan mode simi di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./database/bot/simi.json', JSON.stringify(samih))
						client.sendMessage(from, 'Sukes menonaktifkan mode simi di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
						reply(ind.satukos())
					}
					break
		case 'nsfw':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, 'Sukes mengaktifkan mode nsfw di group ini ✔',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else if (Number(args[0]) === 0) {
						nsfw.splice(from, 1)
						fs.writeFileSync('./database/bot/nsfw.json', JSON.stringify(nsfw))
						client.sendMessage(from, 'Sukes mengaktifkan mode nsfw di group ini ✔',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
		...
		case 'welcome':
                 ...
                 case 'antilink':
					...
					if (Number(args[0]) === 1) {
						...
						client.sendMessage(from, 'Sukses mengaktifkan anti link group di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
						...
						fs.writeFileSync('./database/kelompok/antilink.json', JSON.stringify(antilink))
						client.sendMessage(from, 'Sukes menonaktifkan anti link group di group ini ✔️',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}})
					} else {
